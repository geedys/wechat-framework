...
package com.moonshy.wechatframework.api.csc;
 ...
 * @version
 */
public class WxCustomerServicesAPI {
	private static Logger logger = LoggerFactory.getLogger(WxCustomerServicesAPI.class);
