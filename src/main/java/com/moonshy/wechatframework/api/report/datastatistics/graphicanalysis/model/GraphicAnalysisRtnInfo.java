package com.moonshy.wechatframework.api.report.datastatistics.graphicanalysis.model;
 ...
 */
public class GraphicAnalysisRtnInfo extends BaseData {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8818157565211213351L;
	/**
	...
	/**
	 * @统计的日期，在getarticletotal接口中，<br/> ref_date指的是文章群发出日期， 而stat_date是数据统计日期
	 */
	...
	*/
	...
	private List<GraphicAnalysisRtnInfo> list;

	public List<GraphicAnalysisRtnInfo> getList() {
		return list;
	}

	public void setList(List<GraphicAnalysisRtnInfo> list) {
		this.list = list;
	}
