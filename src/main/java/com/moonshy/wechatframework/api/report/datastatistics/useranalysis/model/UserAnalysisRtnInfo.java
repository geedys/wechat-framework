package com.moonshy.wechatframework.api.report.datastatistics.useranalysis.model;
...
public class UserAnalysisRtnInfo extends BaseData {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4408425467189451720L;
	/**
	 * 数据的日期
	 */
	...
	private List<UserAnalysisRtnInfo> list;

	public List<UserAnalysisRtnInfo> getList() {
		return list;
	}

	public void setList(List<UserAnalysisRtnInfo> list) {
		this.list = list;
	}
