package com.moonshy.wechatframework.api.report.interfacesummary.model;

import java.util.List;

import com.moonshy.wechatframework.core.common.BaseData;

public class InterfaceSummaryHour extends BaseData {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2821215048098017844L;
	// 数据的日期
