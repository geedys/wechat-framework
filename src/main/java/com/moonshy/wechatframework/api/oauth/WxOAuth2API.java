package com.moonshy.wechatframework.api.oauth;

import java.util.Random;

import com.alibaba.fastjson.JSON;
import com.moonshy.wechatframework.api.user.model.UserInfo;
...
public class WxOAuth2API {
	public static String OAUTH_DIRECTURL_REGEX = "https://open\\.weixin\\.qq\\.com/connect/oauth2/authorize\\?appid=.*&redirect_uri=http[s]?://.*&response_type=code&scope=snsapi_userinfo&state=.*#wechat_redirect";
