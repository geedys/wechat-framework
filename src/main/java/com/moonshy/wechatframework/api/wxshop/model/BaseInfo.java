...
public class BaseInfo extends BaseData {
	...
	private static final long serialVersionUID = -2908334896349394990L;
	// 门店名称
	...
	private BaseInfo business;

	private List<BaseInfo> business_list;

	public List<BaseInfo> getBusiness_list() {
		return business_list;
	}

	public void setBusiness_list(List<BaseInfo> business_list) {
		this.business_list = business_list;
	}

	public BaseInfo getBusiness() {
		return business;
	}

	public void setBusiness(BaseInfo business) {
